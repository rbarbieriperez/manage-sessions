...
const ShowDataCategory = ({ data, title }: IShowDataCategory) => {
    return <>
        <Grid2 container display={"flex"} flexDirection={"column"} xs={12} borderRadius={3} boxShadow={"rgba(0, 0, 0, 0.16) 0px 10px 36px 0px, rgba(0, 0, 0, 0.06) 0px 0px 0px 1px"} padding={2}>
